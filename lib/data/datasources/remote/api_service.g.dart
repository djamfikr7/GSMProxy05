...
class _ApiService implements ApiService {
  ...
  Future<List<DeviceModel>> getDevices() async {
    ...
    final _options = _setStreamType<List<DeviceModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<DeviceModel> getDevice(String id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DeviceModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late DeviceModel _value;
    try {
      _value = DeviceModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<List<CallModel>> getCallHistory(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<CallModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<CallModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) => CallModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  @override
  Future<void> initiateCall(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
